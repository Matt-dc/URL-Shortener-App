...
app.get('/:urlParam', (req, res) => {
    ...
    fs.readFile('./urls.json', 'utf8', ( err, data ) => {
        ...
        const urlRedirect = urlArr.find(url => url['shortUrl'].split('/').pop() === urlParam)
...
app.post('/shorten', (req, res) => {
    ...
    if(validUrl.is_http_uri(urlToShorten) || validUrl.is_https_uri(urlToShorten)) {
        ...
        fs.readFile('./urls.json', 'utf8', ( err, data ) => {
            ...
            if(fileData.urls.find(url => url['shortUrl'].split('/').pop() === rand) ) {
